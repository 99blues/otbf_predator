...
public class Beacon {
	...
	public double getDistance(){
		...
		//1mの離れた時のrssi
		double a = -58;
		double distance = Math.pow(10, (this.getRssi() - a)/(-10*gensui));
	...
	public static Beacon createInstance(String uuid, Integer major, Integer minor){
    	Beacon newBeacon = new Beacon();
        newBeacon.setUuid(uuid.toLowerCase());
	...
	public boolean equals(Object o) {
		if(o instanceof Beacon){
			...
			return this.getUuid().equals(otherBeacon.getUuid()) 
					&& this.getMajor().equals(otherBeacon.getMajor()) 
					&& this.getMinor().equals(otherBeacon.getMinor());
		}else{
